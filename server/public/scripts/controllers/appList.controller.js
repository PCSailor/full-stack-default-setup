appVarDefinedInClientJs.controller('AppListController', ['DefaultFactory', function(DefaultFactory) {
...
console.log('appList.controller.js file is loaded');
var self = this;

self.message = 'text from app.controller.js';
